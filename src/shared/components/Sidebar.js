...
const navItems = [
  ...
  { href: "/dashboard/client-routing", label: "Client Routing", icon: "route" },
...
export default function Sidebar({ onClose }) {
  ...
  useEffect(() => {
    if (!UPDATER_CONFIG.showUpdateNotice) return;
    fetch("/api/version")
      .then(res => res.json())
    ...
    <>
      <aside className="flex w-72 flex-col border-r border-border-subtle bg-vibrancy backdrop-blur-xl transition-colors duration-300 min-h-full">
        ...
        <div className="px-6 py-4 flex flex-col gap-2">
          ...
          {UPDATER_CONFIG.showUpdateNotice && updateInfo && (
      ...
      {UPDATER_CONFIG.showUpdateNotice && (
        <ConfirmModal
      ...
      {UPDATER_CONFIG.showUpdateNotice && (isDisconnected || isUpdating) && (
